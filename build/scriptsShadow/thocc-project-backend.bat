...
set CLASSPATH=%APP_HOME%\lib\thocc-project-backend-all.jar

@rem Execute thocc-project-backend
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %THOCC_PROJECT_BACKEND_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%THOCC_PROJECT_BACKEND_EXIT_CONSOLE%" exit 1
exit /b 1
